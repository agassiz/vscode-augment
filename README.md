...
>
> **这是一个仅供学习和研究试用的版本**；现在提供一个月的使用时间，有时间可能会定时更新~~ 如 [v0.524.1-25-0807](https://github.com/agassiz/vscode-augment/releases/tag/v0.524.1-25-0807) 这个版本，有效期是25年09月07
>
> **最近官方正式版本更新频率很高~ 几乎每周都有好几个新的正式版本发布，今天的最新正式版出来了，本人测试通过；欢迎下载 v0.524.1-25-0807，并给个 Star 支持！**
...
2. 下载最新版本 `v0.524.1-25-0807` 的 `.vsix` 文件
...
- **有效期**：约一个月（至2025年09月07日）
- **基于版本**：VSCode Augment 官方版本
- **使用建议**：建议用户关注官方版本的后续更新

## 📝 更新日志

### v0.524.1-25-0807 (修改版) - 最新版本
