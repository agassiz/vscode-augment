...
>
> **这是一个仅供学习和研究试用的版本**；现在提供一个月的使用时间，有时间可能会定时更新~~ 如 [v0.521.1-25-0805](https://github.com/agassiz/vscode-augment/releases/tag/v0.521.1-25-0805) 这个版本，有效期是25年09月05
>
> **最近官方更新太快了~ 还没来的及逆向成功和测试就又出版本了，不过通过努力，今天的最新版本还是出来了，本人测试通过；欢迎下载 v0.521.1-25-0805，并给个 Star 支持！**
...
2. **时效限制**：加有效期是为了防止别人拿去滥用~~~ 现在默认为一个月，一个月的时间官方基本出新版本了，我会在第一时间逆向好最新版本给大家使用
3. **版本跟进策略**：⚠️ **重要说明** - 本插件只对官方最新**正式版本**进行去风控处理，**不包括预览版本**。只跟进官方正式发布的稳定版本，确保使用的稳定性和可靠性
...
2. 下载最新版本 `v0.521.1-25-0805` 的 `.vsix` 文件
