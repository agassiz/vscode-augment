...
>
> **这是一个仅供学习和研究试用的版本**；现在提供一个月的使用时间，有时间可能会定时更新~~ 如 [v0.516.3-25-0801](https://github.com/agassiz/vscode-augment/releases/tag/v0.516.3-25-0801) 这个版本，有效期是25年08月31
>
> **最近官方更新太快了~ 还没来的及逆向成功和测试就又出版本了，不过通过努力，今天的最新版本还是出来了，本人测试通过；欢迎下载 v0.516.3-25-0801，并给个 Star 支持！**
...
2. 下载最新版本 `v0.516.3-25-0801` 的 `.vsix` 文件
...
code --install-extension vscode-augment-0.516.3.vsix
```
